...
def download_isric_data():
    ...
    for variable in variables:
        ...
        if not os.path.exists(f"camels_soils/isric/input_data/isric/{variable}"):
            os.makedirs(f"camels_soils/isric/input_data/isric/{variable}")

        for coverage_id in coverage_ids:
            # check if file already exists
            if os.path.exists(f"camels_soils/isric/input_data/isric/{variable}/{coverage_id}.tiff"):
                continue
            ...
            # save the tiff file
            with open(f"camels_soils/isric/input_data/isric/{variable}/{coverage_id}.tiff", "wb") as file:
